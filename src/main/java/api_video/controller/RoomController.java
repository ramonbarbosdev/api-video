...
import api_video.service.GeradorSequenciaService;
...
public class RoomController {
    ...
    @Autowired
    private GeradorSequenciaService sequenceGenerator;
    ...
    {
        room.setId_room(sequenceGenerator.generateSequence("room_sequence"));
        Room objeto = repository.save(room);
        return new ResponseEntity<>(objeto, HttpStatus.OK);
    }

    @PutMapping(value = "/", produces = "application/json")
    public ResponseEntity<Room> atualizar(@RequestBody Room room)
    {
        Room objeto = repository.save(room);
        return new ResponseEntity<>(objeto, HttpStatus.OK);
    }
